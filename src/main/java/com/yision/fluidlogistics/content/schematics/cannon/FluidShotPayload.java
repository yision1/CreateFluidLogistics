    ...
    public static Data read(CompoundTag data) {
        ...
        try {
            ...
            Fluid fluid = BuiltInRegistries.FLUID
                .getOptional(ResourceLocation.parse(shot.getString("Fluid"))).orElse(null);
            Block host = BuiltInRegistries.BLOCK
                .getOptional(ResourceLocation.parse(shot.getString("Host"))).orElse(null);
