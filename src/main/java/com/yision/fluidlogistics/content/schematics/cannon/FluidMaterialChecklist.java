...
public class FluidMaterialChecklist extends MaterialChecklist {
    ...
    public ItemStack createWrittenClipboard() {
        ...
        if (blocksNotLoaded) {
            page.add(new ClipboardEntry(false,
                Component.translatable("create.materialChecklist.blocksNotLoaded")
        ...
        clipboard.getOrCreateTagElement("display").putString("Name", Component.Serializer.toJson(
            Component.translatable("create.materialChecklist")
                .withStyle(Style.EMPTY.withItalic(false))));
        clipboard.getOrCreateTag().putBoolean("Readonly", true);
        return clipboard;
    }
    ...
    public ItemStack createWrittenBook() {
        ...
        tag.putString("title", "Fluid Checklist");
        book.getOrCreateTagElement("display").putString("Name", Component.Serializer.toJson(
            Component.translatable("fluidlogistics.fluid_material_checklist")
                .withStyle(Style.EMPTY.withItalic(false))));
        return book;
    }
    ...
    private static MutableComponent entry(ItemStack key, int amount, boolean unfinished, boolean forBook) {
        ...
        String formatted = PackageResources
            .formatAmount(key, amount, PackageResourceDisplay.Format.PRECISE)
            .orElse(amount + " mB");
